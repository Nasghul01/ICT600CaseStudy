            ...
            <div class="colm-form" >
                ...
                echo   "<form method='POST' action='".getLogin($conn)."' >
                    <div class='form-container'>
                        ...
                        <button class='btn-login' type='submit' name='loginSubmit'>Log Masuk</button>
                        <a href='signup.php'><button class='btn-login' style='background-color:#e6ccb2; color:white'>Daftar</button></a>
                    </div>
                </form>";
            
                echo "
                <form method='POST' action='".userLogout()."'>
                    <button class='btn-logout' type='submit' name='logoutSubmit'>Log Keluar</button>
                </form>";

                if(isset($_SESSION['id'])){
                    echo "<p>Anda sudah Log masuk!</p>";
                } else {
                    echo "<p>Anda masih belum Log masuk</p>";
                }
                ?>
            </div>
        </div>
